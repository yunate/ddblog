// root path is current file's parent directory
...
// root path is public, do use/xxx.xx rather than ./xxx.xx
export const favIconPath = '/fav.ico';
export const favWebpPath = '/fav.webp';
export const favPngPath = '/fav.png';
